...
with tab5:
    ...
    if not available_seg_cols:
        st.info("📄 Não existem colunas de segmento para orientar recomendações.")
    else:
            ...
            with st.form("group_adjustment_form"):
                ...
                with col2:
                    sleep_quality_delta = st.slider(
                        "Ajuste de Qualidade do Sono (-2 a 2)",
                        -2, 2, 0, 1,
                    )
                ...
                with col3:
                    stress_delta = st.slider(
                        "Ajuste de Stress (-5 a 5)",
                        -5, 5, 0, 1
                    )
                    productivity_delta = st.slider(
                        "Ajuste de Produtividade (-5 a 5)",
                        -5, 5, 0, 1
                    )
